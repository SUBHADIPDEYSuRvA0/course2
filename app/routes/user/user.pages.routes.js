...
router.get("/api/paymenthistory",authMiddleware,userpagesController.paymentHistory)
router.get("/api/mycourses",authMiddleware,userpagesController.mycourses)
router.get("/coursedetails/:id",authMiddleware,userpagesController.getCourseDocuments)
router.post("/api/submitassignment/:id",authMiddleware,userpagesController.submitAssignment)
